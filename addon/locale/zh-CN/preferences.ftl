...
highlights-title = 词性高亮（独立功能）
highlightVerbs =
    .label = 高亮动词
verbHighlightColor = 动词高亮颜色:
highlightNouns =
    .label = 高亮名词
nounHighlightColor = 名词高亮颜色:
highlightConjunctions =
    .label = 高亮连词
conjunctionHighlightColor = 连词高亮颜色:
showSentenceDivider =
    .label = 显示句末分割线
sentenceDividerColor = 句末分割线颜色:
